...
def save_data(sensor,
    ...
    labels_filter = ['time_arr_filter',
                     'jy_lin', 'jy_ext', 'jy_unsc', 'jy_err_lin_cov', 'jy_err_ext_cov', 'jy_err_unsc_cov', 'jy_err_lin', 'jy_err_ext', 'jy_steady_err',
                     'z',
                     'jz_lin', 'jz_ext', 'jz_unsc', 'jz_err_lin_cov', 'jz_err_ext_cov', 'jz_err_unsc_cov', 'jz_err_lin', 'jz_err_ext', 'jz_steady_err',
                     'q_lin', 'q_ext', 'q_unsc', 'q_err_lin_cov', 'q_err_ext_cov', 'q_err_unsc_cov', 'q_err_lin',
                     'q_err_ext', 'q_steady_err',
                     'p_lin', 'p_ext', 'p_unsc', 'p_err_lin_cov', 'p_err_ext_cov', 'p_err_unsc_cov', 'p_err_lin', 'p_err_ext', 'p_steady_err',
